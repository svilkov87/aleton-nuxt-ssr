	...
	data () {
		return {
			...
			contentArray: [
				...
				{
					title: 'Подтверждение знания русского языка',
					description: 'Документ, подтверждающий владение иностранним гражданином русским язуком, знание истории России и основ законодательства Российской Федерации',
					isVisible: false,
					position: 5
				},
			],
